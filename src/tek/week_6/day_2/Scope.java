...
/*
    In programming, scope refers to the region of the code where a particular variable, function, or object is accessible.
     It determines the visibility and lifetime of variables and parameters, as well as functions and classes in
     certain languages. Understanding scope is crucial because it dictates how software entities interact and it
      helps avoid potential naming conflicts and bugs.
 */
/*
...
2. Class Scope (Instance Scope):
	...
	•	They belong to an object (an instance of the class) and are accessible from any non-static method within the class.
