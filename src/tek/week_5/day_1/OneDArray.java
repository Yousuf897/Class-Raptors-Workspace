...
Similarly, to retrieve an item, you open the locker with its unique number and take out what's inside.
In this scenario, the row of lockers is analogous to a 1D array, the unique
locker number corresponds to the array index, and the items inside represent the data we store in the array.

Programming Explanation:

A 1D array in programming is a linear collection of elements that can be accessed by a unique index.
You can populate (store) data in specific positions using this index and retrieve data in a similar manner.
